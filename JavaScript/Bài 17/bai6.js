...
function renderCart() {
  ...
  let listCard = utils.getFromLocalStorage(keyLocalStorageItemCart);
  ...
  document.getElementById("tbody").innerHTML = cartDetails
    ...
    .join("");
  cartDetails.calculateCartTotals();

  document.getElementById("totalQuantity").textContent =
    cartDetails.results.sum;
  document.getElementById("totalPrice").textContent =
    cartDetails.results.totalPrice.toLocaleString("vi-VN");
